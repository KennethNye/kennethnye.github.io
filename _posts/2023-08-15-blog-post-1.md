...
$\mathbf{z}^{k} = \lbrace \mathbf{z}(t) \rbrace_{t = 1,\cdots,k}$. In
...
$\mathbf{z}_{1}^{k - 1} = \lbrace \cdots,\mathbf{z}_{2}(k - 1),\mathbf{z}_{3}(k - 4),\mathbf{z}_{1}(k - 3),\mathbf{z}_{3}(k - 2),\mathbf{z}_{1}(k - 1)\rbrace$ in Fig. 1.
